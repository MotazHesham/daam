                        ...
                        <div class="breadcrumb-content text-center"> 
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">أثبات حضور</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="contact-form-wrap"> 
                            ...
                            @endif
                            <h3 class="mb-4">أثبات حضور دورة <b>{{$course->title}}</b></h3>
                            <form action="{{ route('frontend.course.attend_store') }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="submit-btn text-center">
                                        <button type="submit" class="btn">أثبات حضور</button>
                                    </div>
                                </div>
                            </form>
                        </div>
