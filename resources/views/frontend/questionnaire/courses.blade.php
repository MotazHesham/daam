                        ...
                        <div class="contact-form-wrap"> 
                            ...
                            <form action="{{ route('frontend.questionnaire.store') }}" method="POST">
                                ...
                                <div class="row"> 
                                    <div class="col-md-6">
                                        <div class="form-grp">
                                            <input type="text" placeholder="اسم الدورة" required name="course_name">
                                        </div>
                                    </div> 
                                    <div class="col-md-6">
                                        <div class="form-grp">
                                            <input type="text" placeholder="المدرب" required name="trainer">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-grp">
                                            <input type="text" class="hijri-date-input" placeholder="التاريخ" required name="date">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-grp">
                                        ...
                                        <table class="table" style="background: white">
                                            ...
                                            <tbody>
                                                @foreach(\App\Models\QuestionnaireCourse::Q_SELECT as $key => $lable)
                                                    <tr>
                                                        @if($key == 'question_1')
                                                            <td rowspan="6" class="text-center" style="vertical-align: middle;">
                                                                المدرب
                                                            </td>
                                                        @endif
                                                        @if($key == 'question_7')
