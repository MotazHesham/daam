    ...
    <div class="row">
        ...
        <div class="col-md-6"> 
            ...
            <div style="text-align: right;padding:40px;font-size:35px"> 
                ...
                <div style="clear: both"></div>
                <b style="float: right"> . 2 </b> &nbsp; <span style="text-align: right">ثانيا قم بكتابة رقم الهوية المسجل في الدورة لطلب شهادة الدورة </span> 
                <div style="clear: both"></div>
                <b style="float: right"> . 3 </b> &nbsp; <span style="text-align: right">ثالثا انقر اطلب الان</span>  
                <div style="clear: both"></div>
            </div>
        </div>
    </div>
