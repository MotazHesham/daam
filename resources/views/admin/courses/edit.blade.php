    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.courses.update", [$course->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('attend_type') ? 'is-invalid' : '' }}" name="attend_type" id="attend_type">
            ...
            <div class="form-group">
                <label>{{ trans('cruds.course.fields.certificate') }}</label>
                <select class="form-control {{ $errors->has('certificate') ? 'is-invalid' : '' }}" name="certificate" id="certificate">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('short_description') ? 'is-invalid' : '' }}" name="short_description" id="short_description">{{ old('short_description', $course->short_description) }}</textarea>
