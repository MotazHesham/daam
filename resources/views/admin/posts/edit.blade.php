    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.posts.update", [$post->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>{{ trans('cruds.post.fields.type') }}</label>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date') ? 'is-invalid' : '' }}" type="text" name="date" id="date" value="{{ old('date', $post->date) }}" required>
                @if($errors->has('date'))
                    <div class="invalid-feedback">
                        {{ $errors->first('date') }}
                    </div>
            ...
            <div class="form-group">
                <label for="writer">{{ trans('cruds.post.fields.writer') }}</label>
                <input class="form-control {{ $errors->has('writer') ? 'is-invalid' : '' }}" type="text" name="writer" id="writer" value="{{ old('writer', $post->writer) }}">
                @if($errors->has('writer'))
                    <div class="invalid-feedback">
                        {{ $errors->first('writer') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.post.fields.writer_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="short_description">{{ trans('cruds.post.fields.short_description') }}</label>
                <input class="form-control {{ $errors->has('short_description') ? 'is-invalid' : '' }}" type="text" name="short_description" id="short_description" value="{{ old('short_description', $post->short_description) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('video_link') ? 'is-invalid' : '' }}" name="video_link" id="video_link">{!! old('video_link', $post->video_link) !!}</textarea>
            ...
            <div class="form-group">
                <label class="required" for="photo">{{ trans('cruds.post.fields.photo') }}</label>
