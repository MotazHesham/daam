    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.posts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" name="type" id="type">
                    ...
                    @foreach(App\Models\Post::TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('type', 'news') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('type'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('writer') ? 'is-invalid' : '' }}" type="text" name="writer" id="writer" value="{{ old('writer', '') }}">
