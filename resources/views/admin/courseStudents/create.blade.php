            ...
            <div class="form-group">
                ...
                @foreach(App\Models\CourseStudent::REGISTERED_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('registered') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="registered_{{ $key }}" name="registered" value="{{ $key }}" {{ old('registered', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\CourseStudent::CERTIFICATE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('certificate') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="certificate_{{ $key }}" name="certificate" value="{{ $key }}" {{ old('certificate', '') === (string) $key ? 'checked' : '' }}>
