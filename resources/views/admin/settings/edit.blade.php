    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('divorced_count') ? 'is-invalid' : '' }}" type="text" name="divorced_count" id="divorced_count" value="{{ old('divorced_count', $setting->divorced_count) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('widow_count') ? 'is-invalid' : '' }}" type="text" name="widow_count" id="widow_count" value="{{ old('widow_count', $setting->widow_count) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('child_count') ? 'is-invalid' : '' }}" type="text" name="child_count" id="child_count" value="{{ old('child_count', $setting->child_count) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('unit_count') ? 'is-invalid' : '' }}" type="text" name="unit_count" id="unit_count" value="{{ old('unit_count', $setting->unit_count) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('building_count') ? 'is-invalid' : '' }}" type="text" name="building_count" id="building_count" value="{{ old('building_count', $setting->building_count) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('beneficiary_count') ? 'is-invalid' : '' }}" type="text" name="beneficiary_count" id="beneficiary_count" value="{{ old('beneficiary_count', $setting->beneficiary_count) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('chairman_description') ? 'is-invalid' : '' }}" name="chairman_description" id="chairman_description">{!! old('chairman_description', $setting->chairman_description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('iskan_description') ? 'is-invalid' : '' }}" name="iskan_description" id="iskan_description">{!! old('iskan_description', $setting->iskan_description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('iskan_terms') ? 'is-invalid' : '' }}" name="iskan_terms" id="iskan_terms">{!! old('iskan_terms', $setting->iskan_terms) !!}</textarea>
