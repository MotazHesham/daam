    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#count" role="tab" data-toggle="tab">
                        الأعداد
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#chairman" role="tab" data-toggle="tab">
                        كلمة رئيس مجلس الأدارة
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#iskan" role="tab" data-toggle="tab">
                        وحدة اللإسكان التنموي
                    </a>
                </li>
            </ul>
            <div class="tab-content">
                <div class="tab-pane active" role="tabpanel" id="info">
                    <form method="POST" action="{{ route('admin.settings.update', [$setting->id]) }}"
                        ...
                        @method('PUT')
                        @csrf
                        @includeIf('admin.settings.partials.info')
                ...
                <div class="tab-pane" role="tabpanel" id="count">
                    <form method="POST" action="{{ route('admin.settings.update', [$setting->id]) }}"
                        enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        @includeIf('admin.settings.partials.count')
                ...
                <div class="tab-pane" role="tabpanel" id="about">
                    <form method="POST" action="{{ route('admin.settings.update', [$setting->id]) }}"
                        ...
                        @method('PUT')
                        @csrf
                        @includeIf('admin.settings.partials.about')
                ...
                <div class="tab-pane" role="tabpanel" id="chairman">
                    <form method="POST" action="{{ route('admin.settings.update', [$setting->id]) }}"
                        enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        @includeIf('admin.settings.partials.chairman')
                ...
                <div class="tab-pane" role="tabpanel" id="iskan">
                    <form method="POST" action="{{ route('admin.settings.update', [$setting->id]) }}"
                        enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        @includeIf('admin.settings.partials.iskan')
