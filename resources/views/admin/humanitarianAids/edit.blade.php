...
@section('content')
    <div class="card">
        <div class="card-header">
            {{ trans('global.edit') }} {{ trans('cruds.humanitarianAid.title_singular') }}
        </div>

        <div class="card-body">
            <form method="POST" action="{{ route('admin.humanitarian-aids.update', [$humanitarianAid->id]) }}"
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('type') ? 'is-invalid' : '' }}" type="text" name="type"
                        id="type" value="{{ old('type', $humanitarianAid->type) }}" required>
                    @if ($errors->has('type'))
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('aid_number') ? 'is-invalid' : '' }}" type="number"
                        name="aid_number" id="aid_number" value="{{ old('aid_number', $humanitarianAid->aid_number) }}"
                        step="1" required>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('unit_of_aid') ? 'is-invalid' : '' }}" type="text"
                        name="unit_of_aid" id="unit_of_aid" value="{{ old('unit_of_aid', $humanitarianAid->unit_of_aid) }}"
                        required>
