...
@section('content')
    ...
    <div class="badge-card">
        ...
        <div class="header-svg" >
            <img src="{{ $site_settings->logo ? $site_settings->logo->getUrl() : '' }}" alt="" style="position: absolute;width:180px; left: 39% ">
        ...
        <div class="footer-svg mt-3" style="position: relative">
            <!-- Footer Text -->
            <small class="d-block mt-2" style=" position: absolute; left: 44%; bottom: 4px; color: white;">يستخدم فقط لمهام جمعية دعم التطوعية</small>
