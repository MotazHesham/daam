...
<body>
    <div class="container">
        ...
        <div class="cover">
            <div class="front">
                <img src="{{ asset('frontend/img/slider/slider_bg01.jpg') }}" alt="" />
                <div class="text">
                    ...
                    <form method="POST" action="{{ route('volunteer.login') }}">
                        ...
                        <div class="input-boxes">
                            ...
                            <div class="button input-box">
                                <input type="submit" value="Sumbit" style="background: #000000 !important"/>
                            </div> 
                        </div>
                    </form>
                </div>
