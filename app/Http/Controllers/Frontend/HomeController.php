...
class HomeController extends Controller
{
    ...
    public function projects(){
        $projects = Project::where('published',1)->orderBy('created_at','desc')->paginate(15); 
    ...
    public function posts($type){ 
        ...
        $posts = Post::where('type',$type)->where('published',1)->orderBy('created_at','desc')->paginate(15); 
